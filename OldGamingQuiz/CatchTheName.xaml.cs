...
{
    public partial class CatchTheName : PhoneApplicationPage
    {
        ...
        {
            this.NavigationService.Navigate(new Uri("/LevelPage.xaml?level=lvn1", UriKind.Relative));
        }

        private void StackPanel_Tap_2(object sender, System.Windows.Input.GestureEventArgs e)
        {
            this.NavigationService.Navigate(new Uri("/LevelPage.xaml?level=lvn2", UriKind.Relative));
        }
